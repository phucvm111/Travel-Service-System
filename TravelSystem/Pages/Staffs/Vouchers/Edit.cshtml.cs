...
namespace TravelSystem.Pages.Staffs.Vouchers
{
    public class EditModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                TempData["ErrorMessage"] = "Cập nhật thất bại. Nhập không khả dụng, vui lòng nhập lại.";
                return Page();
            }
            ...
            existingVoucher.UserId = existingVoucher.UserId;
        ...
        private void ValidateVoucher()
        {
            ...
            {
                ModelState.AddModelError("Voucher.MaxDiscountAmount", "Giảm tối đa không được nhỏ hơn giá trị đơn tối thiểu.");
            }
